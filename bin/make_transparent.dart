...
void main() {
  ...
  void addPixel(int x, int y) {
    ...
    // Find the maximum color channel to represent brightness/luminance
    final maxVal = r > g ? (r > b ? r : b) : (g > b ? g : b);

    // If it is background or edge
    if (maxVal < 130) {
      visited[x][y] = true;
      ...
      if (maxVal <= 25) {
        ...
        // Linear interpolation from alpha 0 (at maxVal=25) to alpha 255 (at maxVal=130)
  ...
  // 5. Save the transparent cropped image
  targetFile.writeAsBytesSync(img.encodePng(cropped));
  print('Successfully generated transparent logo.png');
}
